/*
 * UI translations / UI-Übersetzungen
 * Supported languages / Unterstützte Sprachen: de, en
 */
...
const I18N_SOURCE = {
  de: {
    ...
    pvBenefitToday: 'PV-Nutzen heute',
    selfConsumption: 'Eigenverbrauch',
    saving: 'Ersparnis',
    totalBenefit: 'Gesamtnutzen',
    share: 'Anteil',
  ...
  en: {
    ...
    pvBenefitToday: 'PV benefit today',
